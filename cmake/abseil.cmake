...
set(ABSEIL_URL https://github.com/abseil/abseil-cpp/archive/refs/tags/20220623.tar.gz)
set(ABSEIL_BUILD_DIR ${ABSEIL_ROOT}/src/ABSEIL/build)
set(ABSEIL_CONFIGURE mkdir -p ${ABSEIL_BUILD_DIR} && cd ${ABSEIL_BUILD_DIR} && cmake .. -DCMAKE_CXX_STANDARD=17 -DABSL_CXX_STANDARD=17 -DCMAKE_INSTALL_PREFIX=${ABSEIL_ROOT} -DCMAKE_POSITION_INDEPENDENT_CODE=TRUE -DABSL_ENABLE_INSTALL=ON -DCMAKE_MODULE_LINKER_FLAGS=\"-Wl,--no-undefined -Wl,--no-undefined\")
